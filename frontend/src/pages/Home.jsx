...
const Home = () => {
  ...
  return (
    <div className="relative w-full bg-[#0a0e17] text-slate-300 min-h-screen pb-16 overflow-x-hidden selection:bg-emerald-500/30">
      {/* Cinematic Fintech Startup Preloader Overlay */}
      {showPreloader && (
        <Preloader
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute bottom-1/4 right-0 w-[600px] h-[600px] bg-blue-500/5 rounded-full blur-[150px] translate-x-1/3" />
      </div>
      ...
      <div className="relative z-10 space-y-20 sm:space-y-28 lg:space-y-36">
        ...
        <section className="px-3 sm:px-6 lg:px-8 pt-4">
          <Herohome
            ...
            onImagesLoaded={() => setIsReady(true)}
            heroEntranceActive={heroEntranceActive}
          />
        </section>

        {/* 2. Groww-Style Grid Showcase section */}
        <section>
          <GrowwGridShowcase />
        </section>
